...
@Entity(tableName = Constant.CURRENT_TABLE_NAME)
public class CurrentWeatherRespond {
    ...
    public CurrentWeatherRespond(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, @NonNull Integer id, String name, Integer cod) {
        this.coord = coord;
